...
inline void compare_swap_float3(float3* window, unsigned int i, unsigned int j) {
	float3 w_min = min(window[i], window[j]);
	float3 w_max = max(window[i], window[j]);

	window[i] = w_min;
	window[j] = w_max;
}

inline void batcher5x5_float3(float3* w){
	// p = 1
	// k = 1
	compare_swap_float3(w, 0, 1);
	compare_swap_float3(w, 2, 3);
	compare_swap_float3(w, 4, 5);
	compare_swap_float3(w, 6, 7);
	compare_swap_float3(w, 8, 9);
	compare_swap_float3(w, 10, 11);
	compare_swap_float3(w, 12, 13);
	compare_swap_float3(w, 14, 15);
	compare_swap_float3(w, 16, 17);
	compare_swap_float3(w, 18, 19);
	compare_swap_float3(w, 20, 21);
	compare_swap_float3(w, 22, 23);

	// p = 2
	// k = 2
	compare_swap_float3(w, 0, 2);
	compare_swap_float3(w, 1, 3);
	compare_swap_float3(w, 4, 6);
	compare_swap_float3(w, 5, 7);
	compare_swap_float3(w, 8, 10);
	compare_swap_float3(w, 9, 11);
	compare_swap_float3(w, 12, 14);
	compare_swap_float3(w, 13, 15);
	compare_swap_float3(w, 16, 18);
	compare_swap_float3(w, 17, 19);
	compare_swap_float3(w, 20, 22);
	compare_swap_float3(w, 21, 23);
	// k = 1
	compare_swap_float3(w, 1, 2);
	compare_swap_float3(w, 5, 6);
	compare_swap_float3(w, 9, 10);
	compare_swap_float3(w, 13, 14);
	compare_swap_float3(w, 17, 18);
	compare_swap_float3(w, 21, 22);

	// p = 4
	// k = 4
	compare_swap_float3(w, 0, 4);
	compare_swap_float3(w, 1, 5);
	compare_swap_float3(w, 2, 6);
	compare_swap_float3(w, 3, 7);
	compare_swap_float3(w, 8, 12);
	compare_swap_float3(w, 9, 13);
	compare_swap_float3(w, 10, 14);
	compare_swap_float3(w, 11, 15);
	compare_swap_float3(w, 16, 20);
	compare_swap_float3(w, 17, 21);
	compare_swap_float3(w, 18, 22);
	compare_swap_float3(w, 19, 23);
	// k = 2
	compare_swap_float3(w, 2, 4);
	compare_swap_float3(w, 3, 5);
	compare_swap_float3(w, 10, 12);
	compare_swap_float3(w, 11, 13);
	compare_swap_float3(w, 18, 20);
	compare_swap_float3(w, 19, 21);
	// k = 1
	compare_swap_float3(w, 1, 2);
	compare_swap_float3(w, 3, 4);
	compare_swap_float3(w, 5, 6);
	compare_swap_float3(w, 9, 10);
	compare_swap_float3(w, 11, 12);
	compare_swap_float3(w, 13, 14);
	compare_swap_float3(w, 17, 18);
	compare_swap_float3(w, 19, 20);
	compare_swap_float3(w, 21, 22);

	// p = 8
	// k = 8
	compare_swap_float3(w, 0, 8);
	compare_swap_float3(w, 1, 9);
	compare_swap_float3(w, 2, 10);
	compare_swap_float3(w, 3, 11);
	compare_swap_float3(w, 4, 12);
	compare_swap_float3(w, 5, 13);
	compare_swap_float3(w, 6, 14);
	compare_swap_float3(w, 7, 15);
	compare_swap_float3(w, 16, 24);
	// k = 4
	compare_swap_float3(w, 4, 8);
	compare_swap_float3(w, 5, 9);
	compare_swap_float3(w, 6, 10);
	compare_swap_float3(w, 7, 11);
	compare_swap_float3(w, 20, 24);
	// k = 2
	compare_swap_float3(w, 2, 4);
	compare_swap_float3(w, 3, 5);
	compare_swap_float3(w, 6, 8);
	compare_swap_float3(w, 7, 9);
	compare_swap_float3(w, 10, 12);
	compare_swap_float3(w, 11, 13);
	compare_swap_float3(w, 18, 20);
	compare_swap_float3(w, 19, 21);
	compare_swap_float3(w, 22, 24);
	// k = 1
	compare_swap_float3(w, 1, 2);
	compare_swap_float3(w, 3, 4);
	compare_swap_float3(w, 5, 6);
	compare_swap_float3(w, 7, 8);
	compare_swap_float3(w, 9, 10);
	compare_swap_float3(w, 11, 12);
	compare_swap_float3(w, 13, 14);
	compare_swap_float3(w, 17, 18);
	compare_swap_float3(w, 19, 20);
	compare_swap_float3(w, 21, 22);
	compare_swap_float3(w, 23, 24);

	// p = 16
	// k = 16
	compare_swap_float3(w, 0, 16);
	compare_swap_float3(w, 1, 17);
	compare_swap_float3(w, 2, 18);
	compare_swap_float3(w, 3, 19);
	compare_swap_float3(w, 4, 20);
	compare_swap_float3(w, 5, 21);
	compare_swap_float3(w, 6, 22);
	compare_swap_float3(w, 7, 23);
	compare_swap_float3(w, 8, 24);
	// k = 8
	compare_swap_float3(w, 8, 16);
	compare_swap_float3(w, 9, 17);
	compare_swap_float3(w, 10, 18);
	compare_swap_float3(w, 11, 19);
	compare_swap_float3(w, 12, 20);
	compare_swap_float3(w, 13, 21);
	compare_swap_float3(w, 14, 22);
	compare_swap_float3(w, 15, 23);
	// k = 4
	compare_swap_float3(w, 4, 8);
	compare_swap_float3(w, 5, 9);
	compare_swap_float3(w, 6, 10);
	compare_swap_float3(w, 7, 11);
	compare_swap_float3(w, 12, 16);
	compare_swap_float3(w, 13, 17);
	compare_swap_float3(w, 14, 18);
	compare_swap_float3(w, 15, 19);
	compare_swap_float3(w, 20, 24);
	// k = 2
	compare_swap_float3(w, 2, 4);
	compare_swap_float3(w, 3, 5);
	...
	compare_swap_float3(w, 10, 12);
	compare_swap_float3(w, 11, 13);
	compare_swap_float3(w, 14, 16);
	compare_swap_float3(w, 15, 17);
	compare_swap_float3(w, 18, 20);
	compare_swap_float3(w, 19, 21);
	compare_swap_float3(w, 22, 24);
	// k = 1
		...
		__global unsigned char* gOutput)
{
	...
	for(int i = 0; i < 2; ++i){
		...
		if(win_row < 20 && win_col < 20){
			...
			vstore3(convert_float3(vload3(0, gInput + rd_offset)), 0, data + local_idx);
		}
	}
