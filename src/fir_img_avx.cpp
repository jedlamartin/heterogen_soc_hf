...
void batcher_sort_5x5(__m256i *w) {
  ...
  compare_swap(w, 7, 10);
  compare_swap(w, 8, 11);
  compare_swap(w, 12, 15);
  compare_swap(w, 13, 16);
  compare_swap(w, 14, 17);
  compare_swap(w, 18, 21);
  compare_swap(w, 19, 22);
  compare_swap(w, 20, 23);

  compare_swap(w, 3, 6);
  compare_swap(w, 4, 7);
  compare_swap(w, 5, 8);
  compare_swap(w, 9, 12);
  compare_swap(w, 10, 13);
  compare_swap(w, 11, 14);
  compare_swap(w, 15, 18);
  compare_swap(w, 16, 19);
  compare_swap(w, 17, 20);
  compare_swap(w, 21, 24);

  compare_swap(w, 6, 12);
  compare_swap(w, 7, 13);
  compare_swap(w, 8, 14);
  compare_swap(w, 10, 15);
  compare_swap(w, 11, 16);
  compare_swap(w, 12, 18);
  compare_swap(w, 13, 19);
  compare_swap(w, 14, 20);
  ...
  compare_swap(w, 8, 20);
  compare_swap(w, 9, 21);
  compare_swap(w, 10, 22);
  compare_swap(w, 11, 23);
  ...
  compare_swap(w, 4, 9);
  compare_swap(w, 5, 10);
  compare_swap(w, 11, 18);
  compare_swap(w, 12, 19);
  compare_swap(w, 13, 20);
  compare_swap(w, 14, 21);
  compare_swap(w, 15, 22);
  compare_swap(w, 16, 23);
  ...
  compare_swap(w, 13, 19);
  compare_swap(w, 14, 20);
  compare_swap(w, 15, 21);
  compare_swap(w, 16, 22);
  compare_swap(w, 17, 23);
...
void median2d_avx_uload(int32_t imgHeight, int32_t imgWidth, int32_t imgWidthF,
                        uint8_t *imgSrcExt, uint8_t *imgDst) {

#pragma omp parallel for
  for (int32_t row = 0; row < imgHeight; ++row) {
    for (int32_t col = 0; col < imgWidth * 3; col += 32) {
      __m256i window[WIN_LENGTH * WIN_HEIGHT] __attribute__((aligned(32))) = {};
